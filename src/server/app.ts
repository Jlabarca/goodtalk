...
class Server {
    ...
    private databases(): void {
        // MongoDB URL
        let mongoDBUrl = process.env.MONGODB_URI || 'mongodb://localhost/note';
    ...
    private sockets(): void {
        ...
        let noteSocket = new NoteSocket(this.io);
    }
    ...
    private listen(): void {
        ...
        this.server.on("connect", () => {
                    console.log('==> CONSAODNSAODN on port %s. Open up http://localhost:%s/ in your browser.', this.port, this.port);            
                });
    }
}
